            ...
            else
            {
                ...
                try
                {
                    using (OracleConnection conn = new OracleConnection(connectionString))
                    {
                        ...
                        conn.Open();
                        string sqlq = "UPDATE MED_INFO SET MED_NAME='" + textBox1.Text + "',MED_STG='" + textBox6.Text +
                                      "',MED_MGF='" + mgf + "',MED_BATCH='" + textBox3.Text + "',MED_GROUP='" + grp +
                                      "',MED_TYPE='" + mtype + "',COST_PRICE='" + textBox4.Text + "',SELL_PRICE='" +
                                      textBox2.Text + "',NOTES='" + richTextBox1.Text + "' WHERE MED_ID='" + nid + "'";
